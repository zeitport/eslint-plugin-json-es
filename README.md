...
[![CodeQL](https://github.com/zeitport/eslint-plugin-json/workflows/codeql-analysis/badge.svg?branch=main&event=push)](https://github.com/zeitport/eslint-plugin-json/actions?query=workflow%3Acodeql-analysis)
